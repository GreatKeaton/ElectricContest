    ...
    <div class="chat-room" v-show="!isNotes">
      <div class="chat-content">
        <dl v-for="(item,index) in listDate" v-bind:key="index">
          <dt>{{item.time}}</dt>
          <dd>
            <i @click="isMsgbox=true; isUserLevel=true;" class="cspn" :class="'grade'+item.grade"></i>
        ...
        <div class="query-inp relative">
          <span class="user-query" @click="isQueryUser = !isQueryUser">
            ...
            <ul class="query-option" v-show="isQueryUser">
              <li>Bet info</li>
              <li>Achivement Rank</li>
              <li>User</li>
            </ul>
          </span>
          <input type="text" placeholder="Please input your search">
          <span class="search">
...
.sun-dry-area {
  ...
  .my-notes {
    ...
    & > h2 {
      ...
      padding-bottom: 10px;
      margin-bottom: 20px;
      border-bottom: 1px solid #75a2cc;
      .tx-ct;
    }
    ...
    .lement-box {
      ...
      dt {
        ...
        &::after{
          content: '';
          background: url('../../../images/home/right/photo.png') no-repeat center center;
          margin-top: 10px;
          .cspn;
          .right;
          width: 16px;
    ...
    .user-detail {
      ...
      .lift {
        ...
        &::after {
          ...
          width: 10px;
          height: 15px;
          background: url("../../../images/home/right/down.png") no-repeat
            center center;
          margin-left: 6px;
          vertical-align: -2px;
          .in-block;
      ...
      .group-btn {
        ...
        button {
          ...
          &:first-child{
            margin-right: 5%;
            color: #fff;
            background: url('../../../images/home/nav/zh-active.png') no-repeat center center;
            background-size: 100% 100%;
          }
        }
      }
